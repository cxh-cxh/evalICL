...
examples = load_jsonl("./test_cases.jsonl", limit=30)
...
Goal: Predict an integer difficulty D in [0,2].
Interpretation: approximate success rate ≈ (100 - 50 * D)%. 0 = almost certainly succeeds, 2 = almost certainly fails.
...
Then give a difficulty rating for each of the factors you analyzed on a scale of 0-2 in the <rating> and </rating> tags below.

<rating>
[Write your difficulty rating here, e.g., "factor1: 3, factor2: 5, ..."]
</rating>

Finally provide a difficulty value from 0 to 2 between <difficulty> and </difficulty> tags.

<difficulty>
[Provide a single integer of 0 to 2]
</difficulty>
