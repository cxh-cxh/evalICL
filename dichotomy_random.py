...
queries, examples = load_jsonl("./test_cases.jsonl")
...
Goal: Predict an difficulty in 0 or 1.
Interpretation: 0 means almost certainly succeeds and 1 is almost certainly fails.
...
- Position of the two cubes in the reference system of the work space and the dynamic constraints of the robot.
...
Then give a difficulty rating for each of the factors you analyzed on a scale of 0-10 in the <rating> and </rating> tags below.

<rating>
[Write your difficulty rating here, e.g., "factor1: 3, factor2: 5, ..."]
</rating>

Finally provide a difficulty in 0 or 1 between <difficulty> and </difficulty> tags.

<difficulty>
[Provide a single integer of 0 or 1 here]
</difficulty>
