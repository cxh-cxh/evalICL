...
keys = [
    "pi0_t10003_sim_env_12",
    "pi0_t10003_sim_env_13",
    "pi0_t10003_sim_env_23",
]

ref_key = "pi0_t10003_sim_mixed"
...
width = 1
count = len(data[0])
y_lim_high = [0.25, 0.45]
y_lim_low = [0, 0.075]

ax1, ax2 = broken_bar(y_lim_high, y_lim_low)
ax1.set_title(
    "Pick and Place (Sim) Task Scores",
    fontweight="bold",
    size="x-large",
)
