...
- Position of the two cubes in the reference system of the work space, the distance of the two cubes, the distance of each cube with the robot.
- The dynamic constraints of the robot.
- The backgrounds and lighting conditions. If the background is drastically different from training data, or if the color is prone to be confused with the cubes' color, the model may behave poorly.
