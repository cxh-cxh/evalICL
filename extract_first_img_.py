...
video_root = "/mnt/sdb/benchmarking/videos/pi0_t10_generalist_t100002_2mm"

save_path = "images/t100002_2mm_env1"
os.makedirs(save_path, exist_ok=True)

front_videos = natsorted(glob.glob(os.path.join(video_root, "front_*")))
side_videos = natsorted(glob.glob(os.path.join(video_root, "side_*")))


for id in range(50):
    front_img = read_first_img(front_videos[id * 10])
    side_img = read_first_img(side_videos[id * 10])
