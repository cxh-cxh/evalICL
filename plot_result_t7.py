...
keys = [
    "pi0_t7_246",
    "pi0_t7_135",
    "pi0_t7_staged_013245",
    "pi0_t7_staged_542310",
    # "pi05_task40_staged_312",
]

ref_key = "pi0_t7_full"

data = np.array(
    [[data_[func_names[0]][key]["old"][149] for key in keys]]
    + [[data_[func_name][key]["new"][149] for key in keys] for func_name in func_names]
)
ref = np.array(
    [data_[func_names[0]][ref_key]["old"][149]]
    + [data_[func_name][ref_key]["new"][149] for func_name in func_names]
)
...
ax1.add_line(line0)
ax1.set_xticks([(count + 1) * width * x + 1.5 for x in range(4)], ticks)
